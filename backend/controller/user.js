...
const register = async (req, res) => {
  ...
  pool.query(
      "INSERT INTO Users (role_id, first_name, last_name, email, password, phone_number, country, username, i) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)",
      [
        role_id,
        first_name,
        last_name,
      ...
      if (result.rows.length > 0) {
        bcrypt.compare(password, result.rows[0].password, (err, response) => {
          ...
          if (response) {
            ...
            const ipAdddressQuery = ("INSERT INTO ip_adress (user_id, ip_address) VALUES ($1, $2)", [userId,ipAddress]);
            pool.query(ipAdddressQuery).then().catch((err) => console.log(err));
              res.status(200).json({
                token,
                success: true,
