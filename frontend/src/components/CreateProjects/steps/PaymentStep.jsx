    ...
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-8">
      <div className="mb-6">
        <h2 className="text-2xl font-black tracking-tight text-slate-900">
          {isTask ? "Preview & Submit Task" : "Payment & Submit"}
        </h2>
        <p className="text-slate-600">
          {isTask
            ? "Review your task details before publishing."
            : "Review your project and upload payment proof to continue."}
        </p>
      </div>
        ...
        <div className="grid gap-3">
          <div className="bg-white rounded-xl p-4 border border-slate-200">
            ...
            <p className="text-slate-900 font-medium mt-1">
              {projectData.title || "No title provided"}
            </p>
          </div>
      ...
      <div className="flex gap-4">
        ...
        <button
          onClick={onSubmit}
          disabled={isSubmitting || (!isTask && !proofFile)}
