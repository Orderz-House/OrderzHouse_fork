  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p style={{ marginTop: "1rem", fontSize: "2.5rem", fontWeight: "700" }}>
          {plan.subscriptionFee} JD
        </p>
        <p
          style={{
            color: "#000000ff",
        ...
        <p style={{ marginTop: "1rem", fontSize: "1.5rem", color: "#065f46" }}>
          {plan.description}
        </p>
      </div>
      <GradientButton
        ...
        onMouseEnter={(e) => (e.currentTarget.style.background = "#026e7a")}
        onMouseLeave={(e) => (e.currentTarget.style.background = "#028090")}
      >
        Choose {plan.name}
      </GradientButton>
    </div>
  ...
  return (
    <div style={bodyStyle}>
      ...
      <div style={noteStyle}>
        ...
        <p>
          * Account verification fee is a one-time payment across all plans (25
          JD).
        </p>
      </div>
    </div>
