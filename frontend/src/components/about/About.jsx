...
import { Users, Target, Heart, Zap, Shield, Award, TrendingUp, Globe, CheckCircle, ArrowRight, Star, Play, Calendar, MapPin, Mail, Phone } from 'lucide-react';
...
export default function ModernAboutPage() {
  ...
  const whyChooseUs = [
    { title: "Verified professionals", desc: "All freelancers are thoroughly vetted" },
    { title: "Secure payment gateways", desc: "Your transactions are 100% secure" },
    { title: "Transparent project tracking", desc: "Real-time progress monitoring" },
    { title: "Quality assurance", desc: "Every project meets high standards" },
    { title: "Direct marketing approach", desc: "Targeted strategies that work" },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12">
              We're redefining the future of freelancing by connecting visionaries with exceptional talent, 
              where creativity meets reliability to build a distinguished future.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div 
              ...
              className={`transform transition-all duration-700 ${
                isVisible['who-we-are'] ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'
              }`}
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                ORDERZHOUSE is a curated freelance marketplace connecting brilliant minds with bold ideas. 
                We're more than just a platform — we're a movement reshaping the future of independent work.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">To empower freelancers and businesses through seamless, secure, and smart collaborations.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div 
              ...
              id="team-image"
              className={`transform transition-all duration-700 ${
                isVisible['team-image'] ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'
              }`}
            >
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The passionate individuals driving innovation and excellence at ORDERZHOUSE.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We don't just connect — we cultivate long-term collaborations through innovation and trust.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 rounded-3xl p-12 lg:p-20 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
                ...
                Connect with top talent or showcase your skills to global clients.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                <button className="px-10 py-4 border-2 border-white/30 text-white font-bold rounded-2xl hover:border-white hover:bg-white/10 transition-all duration-300 flex items-center justify-center space-x-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Shortlist and hire with confidence. Streamline your hiring process by evaluating candidates 
                holistically. Get a detailed and complete platform for making your intelligent decisions.
              </p>
