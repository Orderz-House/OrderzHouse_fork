...
// Verification & Rating
usersRouter.get("/verification/status", authentication, checkVerificationStatus);
usersRouter.post("/verification/update", authentication, updateVerificationStatus);
